...
public class MusixMatchGetter extends LyricsGetterLiveAble {
    ...
    private Map<String, String> getCookies() {
        final String userToken = ConfigManager.getConfig().getLyrics().getMusicmatchAuthToken();
    ...
    public boolean canGetLyrics(String songName) {
        Logger.log(ConfigManager.getConfig().getLyrics().getMusicmatchAuthToken().isEmpty() ? "No musicmatch auth token set, lyrics will not be fetched." : "Musicmatch auth token set, lyrics will be fetched.");
        return !ConfigManager.getConfig().getLyrics().getMusicmatchAuthToken().isEmpty();
    }
